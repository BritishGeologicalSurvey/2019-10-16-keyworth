...
venue: "BGS Keyworth"        # brief name of host site without address (e.g., "Euphoric State University")
address: "Meeting Room 4"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
enddate: "2019-10-17"        # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
instructor: ["Chris Williams", "Andy Hulbert", "Ekbal Hussain"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
